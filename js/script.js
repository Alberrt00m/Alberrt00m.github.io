...
// nivel 1
      {
        ...
        estrellaRoja: { x: 100, y: SUELO_Y - 320, radio: 15, recogida: false },
        estrellaAzul: { x: 740, y: SUELO_Y - 320, radio: 15, recogida: false },
      },
// nivel 2
      {
        plataformas: [
        ...
        estrellaRoja: { x: 450, y: SUELO_Y - 350, radio: 12, recogida: false },
        estrellaAzul: { x: 400, y: SUELO_Y - 350, radio: 12, recogida: false },
      },
...
// nivel 3
      {
        ...
        estrellaRoja: { x: 395, y: SUELO_Y - 15, radio: 12, recogida: false },
        estrellaAzul: { x: 435, y: SUELO_Y - 15, radio: 12, recogida: false },
...
// nivel 4
      {
        ...
        estrellaRoja: { x: 185, y: SUELO_Y - 15, radio: 12, recogida: false },
        estrellaAzul: { x: 225, y: SUELO_Y - 15, radio: 12, recogida: false },
      },
...
// nivel 5
    ...
    function dibujarEstrella(est, color) {
      ...
      const grad = ctx.createRadialGradient(x, y - radio * 0.2, 0, x, y, radio);
